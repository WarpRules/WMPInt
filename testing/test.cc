...
std::ostream& operator<<(std::ostream& os, const WVLUInt<kSize>& value)
{
...
{
    using UInt_t = WVLUInt<sizeof...(Values_t)>;
    UInt_t v1, v2(values...);
...
{
    WVLUInt<sizeof...(Values_t)> v1, v2(values...);
...
static bool checkAddition(const Value_t1& value1, const Value_t2& value2,
                          const WVLUInt<kSize>& expectedResult)
{
    const WVLUInt<kSize> result = value1 + value2;
...
{
    WVLUInt<kSize> value1(-1), value2(1), value3(0);
    ...
    WVLUInt<kSize> value4(-1), value5(0);
    ...
    for(std::size_t i = 0; i < kSize; ++i)
        value3.data()[i] = -1;
    value2 = WVLUInt<kSize>(2);
    value1 = WVLUInt<kSize>(1);
...
{
    WVLUInt<2> input1(v1_msw, v1_lsw), input2(v2_msw, v2_lsw);
    WVLUInt<2> output = input1 * input2;
...
static bool testMultiplicationWithSize2()
{
    ...
    for(unsigned i = 0; i < 1000000; ++i)
    {
        ...
        const WVLUInt<1> input1(rngEngine()), input2(rngEngine());
...
static bool testMultiplicationWithPatterns(unsigned bitPattern1, unsigned bitPattern2)
{
    ...
    WVLUInt<kSize> result = value1 * value2, expectedResult;
...
{
    std::mt19937_64 rngEngine(0);
    WVLUInt<kSize> value, factor(0), result1, result2;
...
static bool testMultiplication(const WVLUInt<kSize>(&array)[kArraySize][3])
{
    for(std::size_t i = 0; i < kArraySize; ++i)
    {
        ...
        for(unsigned j = 0; j < 3; ++j)
        {
            ...
            const WVLUInt<kSize> doubleValue = array[i][j] + array[i][j];
...
(const WVLUInt<kSize>& value1, const WVLUInt<kSize>& value2, const char* resultStr)
{
    WVLUInt<kSize> result1;
    ...
    WVLUInt<kSize*2> value3, value4, result2;
...
{
    const struct { WVLUInt<2> v1, v2; const char* resultStr; } values2[] =
    {
     {WVLUInt<2>(0xC96D191CF6F6AEA6, 0x401F7AC78BC80F1C),
      WVLUInt<2>(0xB5EE8CB6ABE457F8, 0xF258D22D4DB91392),
     "8F25D4E638153EA10F73DF4CDD71573EE186F458DDF0582BFF7FA537E873B1F8"},
     {WVLUInt<2>(0x04EEF2B4B5D860CC, 0x67A7AABE10D172D6),
      WVLUInt<2>(0x40565D50E72B4021, 0x05D07B7D1E8DE386),
     "13D66BF13771FCC41652F415CB0BECF98DABCE9DA23682793239BB5DA53DE04"},
     {WVLUInt<2>(0x8548DEA130821ACC, 0x583C502C832E0A3A),
      WVLUInt<2>(0x4631AEDE2E67FFD1, 0x8F9FCCBA4388A61F),
     "248BCADDE4C9B87EBAE09FEE15E476C6CC293CCC47867284C8E4F5BA5A04D906"},
     {WVLUInt<2>(0x23D9A035F5E09570, 0x8B3A26B7AA4BCECB),
      WVLUInt<2>(0x859C449A06E0302C, 0xDB696AB700FEB090),
     "12B5F2750A0EB730A2DBD6E29789B79424F8A616C4C69A6A4FA2E4B81639E230"},
     {WVLUInt<2>(0x7FF1366399D92B12, 0x6B5BD57A3C9113EF),
      WVLUInt<2>(0xBE892B0C53E40D3D, 0x3FC97B87BED94159),
     "5F3993F7B4DAF8C700A83AEB65749839D6A860C1480C43456E6E9CAE2C169D17"},
     {WVLUInt<2>(0x3D413B8D11B4CCE2, 0x51EFC5D2498D7506),
      WVLUInt<2>(0xE916957641C27421, 0x2A327E8F39FC19A6),
     "37C5C691C6B3B9AF6D8024B2CE363EB069D021F1EA856118A5F608320A0F77E4"},
     {WVLUInt<2>(0x3EDB3BFE2F0B6337, 0x32C51436B7C00275),
      WVLUInt<2>(0xB744BED2696ED37E, 0xF7C35C861856282A),
     "2CFF98F90366A21CC2A221D2DEC683802EBCA1CF55DE8BFAFC9BEDA9F130AF32"},
     {WVLUInt<2>(0xC4F978FB19FFB724, 0x14A93CA1D9BCEA61),
      WVLUInt<2>(0x75BDA2D6BFFCFCA4, 0x41DBE94941A43D12),
     "5A97EDC42F16E213A5E523565A0A9101BE47635FAC6425DCE17D67751A4597D2"},
     {WVLUInt<2>(0xC6EC7495AC0E00FD, 0x957955653083196E),
      WVLUInt<2>(0xF346DE027CA95D44, 0x702751D1BB724213),
     "BD0983D4EF0F2E2F01A5AA6E174456F7916A8BD156CCD70B675A5BC713453F2A"},
     {WVLUInt<2>(0x528184B1277F75FE, 0x884BB2027E9AC7B0),
      WVLUInt<2>(0x41A0BC6DD5C28762, 0x0BA88011CD101288),
     "1526B05E6D3C1A3EA609A35C3AF565D0F2D1BDD0D219C61441E3DC7E8F447580"},
     {WVLUInt<2>(0x814621BD927E0DAC, 0xB23CB1552B043B6E),
      WVLUInt<2>(0x175A1FED9BBDA880, 0xE838FF59B1C9D964),
     "BCACFCF5F7741150435C6DC4FE1C1570B4E07F95F57450C0C5E65631B6574F8"},
     {WVLUInt<2>(0x07EA06B48FCA72AC, 0x26EBDCF08553011A),
      WVLUInt<2>(0xFB44EA3C3A45CF1C, 0x9ED34D63DF99A685),
     "7C495FA97B97BF5D554282F01ED13DD57A50BCDE77FF927348CFB0865606E82"},
     {WVLUInt<2>(0x4C7BF671EAEA7207, 0x5C7FC5FC683A1085),
      WVLUInt<2>(0x7B20C584708499B9, 0x4C3FB0CEB4ADB6B9),
     "24C959EA804A9845B12A1F1063A4C0049EF5221F55E825B54AC2836147957E1D"},
     {WVLUInt<2>(0x4902095A15D7F3D2, 0xEC97F42C55BC9F40),
      WVLUInt<2>(0xA0FFC0F9681BB9AC, 0xC149BD468AC1AC86),
     "2DEA35E846121F783B82F9525C8566B12B52606BB01304D147A1B55C2AFA5B80"},
     {WVLUInt<2>(0xB6C1A68207BA2FC9, 0xB906A73E05A92C74),
      WVLUInt<2>(0x11E0D6EBD61D941D, 0x7CA12FB5B05B5C4D),
     "CC35EEE9219AAC68204418261B41CD25EAC9BD19E3F727856C4A3670D180EE4"},
     {WVLUInt<2>(0x16BF95DEFA2CD170, 0xC27697252E02CB81),
      WVLUInt<2>(0x6C7F49BF802C66F5, 0x98D3DAAA3B2E8562),
     "894B4B112C61EDF08D31E87E483B346038512E9B7078B59BFCE6E9E610457D78"},
     {WVLUInt<2>(0xE4EA67D4C915E61A, 0x1DEBFA223CA7EFE1),
      WVLUInt<2>(0xA77DFC79C3A3071A, 0x06CC239429A34614),
     "95C591F422045701DE82218F973465861D348EA1F44109EB1086DCAF6DF94394"},
     {WVLUInt<2>(0x4927012902F7E84C, 0x9CA15A0AFF31237F),
      WVLUInt<2>(0x5D9E9BC902C99CA8, 0x47FA9818255561FF),
     "1AC07E02AB838CCAB8938256D0353ABB979ACAE2D6BB3DF9A1146CFFF4907A81"},
    };

    const struct { WVLUInt<8> v1, v2; const char* resultStr; } values8[] =
    {
     {WVLUInt<8>(0xC96D191CF6F6AEA6, 0x401F7AC78BC80F1C, 0xB5EE8CB6ABE457F8, 0xF258D22D4DB91392,
                 0x04EEF2B4B5D860CC, 0x67A7AABE10D172D6, 0x40565D50E72B4021, 0x05D07B7D1E8DE386),
      WVLUInt<8>(0x8548DEA130821ACC, 0x583C502C832E0A3A, 0x4631AEDE2E67FFD1, 0x8F9FCCBA4388A61F,
     ...
     {WVLUInt<8>(0x7FF1366399D92B12, 0x6B5BD57A3C9113EF, 0xBE892B0C53E40D3D, 0x3FC97B87BED94159,
                 0x3D413B8D11B4CCE2, 0x51EFC5D2498D7506, 0xE916957641C27421, 0x2A327E8F39FC19A6),
      WVLUInt<8>(0x3EDB3BFE2F0B6337, 0x32C51436B7C00275, 0xB744BED2696ED37E, 0xF7C35C861856282A,
     ...
     {WVLUInt<8>(0xC6EC7495AC0E00FD, 0x957955653083196E, 0xF346DE027CA95D44, 0x702751D1BB724213,
                 0x528184B1277F75FE, 0x884BB2027E9AC7B0, 0x41A0BC6DD5C28762, 0x0BA88011CD101288),
      WVLUInt<8>(0x814621BD927E0DAC, 0xB23CB1552B043B6E, 0x175A1FED9BBDA880, 0xE838FF59B1C9D964,
     ...
     {WVLUInt<8>(0x4C7BF671EAEA7207, 0x5C7FC5FC683A1085, 0x7B20C584708499B9, 0x4C3FB0CEB4ADB6B9,
                 0x4902095A15D7F3D2, 0xEC97F42C55BC9F40, 0xA0FFC0F9681BB9AC, 0xC149BD468AC1AC86),
      WVLUInt<8>(0xB6C1A68207BA2FC9, 0xB906A73E05A92C74, 0x11E0D6EBD61D941D, 0x7CA12FB5B05B5C4D,
     ...
     {WVLUInt<8>(0x161F5FC4BA37F6D7, 0x45E0C63E93FC6383, 0x9FB1DBFBC95C83A0, 0x38DDD8A535D2CBBD,
                 0x39B6F08DAF36CA87, 0x6F23D32E2A0FD7FA, 0xFCC027348974B455, 0x360369EDA9C0E07D),
      WVLUInt<8>(0xDA6C4763C2C466D7, 0x48BBB7A741E6DDD9, 0xD61C0C76DEB4818C, 0x5DE152345F136375,
     ...
     {WVLUInt<8>(0x5CB3B670AE90BE6C, 0xBC87A781B47462CE, 0x84F579568A8972C8, 0x6C469AD3CBA9B91A,
     {WVLUInt<8>(0x7F2AD107F8DDBA2A, 0x2E197DF35C7E33D0, 0x3342BDC7261F4934, 0x545E592429A921A0,
                 0x9E38EED1159F80E7, 0x32BD802173987166, 0x18152C657FA3FDC9, 0x381AC4340644F60A),
      WVLUInt<8>(0xB06A021391C6263F, 0x83D7D646BE018650, 0xD44E6328654B039C, 0x881702698D3039A6,
     ...
     {WVLUInt<8>(0xD408DE8798EDF4C9, 0x5948D49B54687E6B, 0x2E19C96C7EEEDBB5, 0x9E13DF7704F263C4,
                 0xA00178BB1A246B2A, 0x8F577B49109FA213, 0xE3FDA5C99BA516EF, 0xF8C83BAAEDCE1B21),
      WVLUInt<8>(0x09C9D2514F4C6672, 0x707BC41893479754, 0xD62FF90A17D2F0A7, 0x338D964BACBD1567,
     ...
     {WVLUInt<8>(0xDE9D15D1C2E1C933, 0x8B7BB05EF9B36624, 0xCC6FC44CAD352A48, 0x8158FBD46DF064EF,
                 0xD011E08D9B6793A0, 0x3A0109F5EABFA0D7, 0x7C2C55F6DC851EC6, 0xCC36D694CB80EA65),
      WVLUInt<8>(0x2452E607628E3FC9, 0x42DD5C29BD374369, 0x31FFC4530976E732, 0xCBB7982155BA1E91,
     ...
     {WVLUInt<8>(0xD00943C0D75A8642, 0xC116FEAE7B04B894, 0xC5C9D8290E0D7659, 0x1544DAD8340F92E3,
                 0x8EB55E64E301853E, 0xF06F431AF28642FE, 0xDBAE5E167D68F32C, 0x69C5A706E980AF6C),
      WVLUInt<8>(0x943ED2620BE0F7B4, 0x19A342DAD554652E, 0x2A8D8D1B50DE029C, 0xCB153694CE6622F7,
     ...
     {WVLUInt<8>(0xC832465983EEE93F, 0x44EE962A18AB4006, 0x9D54596C7295C71F, 0x80F7C94CB2B48C46,
                 0xFC8E664247F1387F, 0x2CEA8E49FFAE300D, 0x32C9CCCCD6DFD23A, 0x47F7BDB6D73CBED4),
      WVLUInt<8>(0x19455B1D84B65E8D, 0x46D2EEFB41E91DF6, 0xE07DF83693C0D21C, 0xD9DFC1443A4360A7,
     ...
     {WVLUInt<8>(0x2612FD2EBEE5339E, 0x6DE203C61C0D3F5E, 0x7F9AA20E88E99B8D, 0x7164159E7AB19146,
                 0x2746EFF1B1C1E1E6, 0x660E49FF9DC47ED8, 0xF4B9E04E02949223, 0x762BC665D2D40655),
      WVLUInt<8>(0x50C104B3A7A2D41A, 0x7678F589D0F5486D, 0x288699D9339EF00F, 0x3A5F59D818F3C968,
     ...
     {WVLUInt<8>(0xAB1BF7646B530A67, 0x4D2046F6F75BE8BF, 0xF6BB5B7C9EA653CE, 0xF30ED07C3B17D1B3,
                 0xF6DC1F405B6BD912, 0xEE01B35A96A1F6C5, 0x0156C6B916E4EF03, 0x4AD363F901DB8C4F),
      WVLUInt<8>(0xB8BD7262C9FFC05A, 0x02F38B61B74C8B8C, 0xEC38BDB33DDF8C86, 0x9D534BA6B1AE1D13,
...
static bool testMultiplication()
{
    ...
    const WVLUInt<3> values3[][3] =
    {{ WVLUInt<3>(0xABCDEF0123456789, 0x1234567890ABCDEF, 0xAABBCCDDEEFF0011),
       WVLUInt<3>(0x8ABFC0F2BF8AF59E, 0x2E0191B18E8BA3AB, 0x9856577ABDDE0121),
       WVLUInt<3>(0xA61B6ABF0B698C4D, 0x0E9068C41A05CEB6, 0xEC2B99D3699D1331) },
     { WVLUInt<3>(0xFF12FF23FF34FF45, 0xF0F1F2F3F4F5F6F7, 0xAFBFCFDFEFFFAFBF),
       WVLUInt<3>(0x0DA9199103B18B96, 0x11B8D85103D1D264, 0xDFAC7A483928B081),
       WVLUInt<3>(0xD7975D393A1FEF33, 0xD78B72B8101364BD, 0x94FD96A4B582DF3F) },
     { WVLUInt<3>(0xABCDEF0123456789, 0x1234567890ABCDEF, 0xAABBCCDDEEFF0011),
       WVLUInt<3>(0xFF12FF23FF34FF45, 0xF0F1F2F3F4F5F6F7, 0xAFBFCFDFEFFFAFBF),
       WVLUInt<3>(0x153C82E80E5ECD21, 0x2E6437444EA8D222, 0x13387ED5913BABAF) },
     { WVLUInt<3>(0x5AAB3001022EFFED, 0x10598294EF43D4F2, 0x113253907ED64ED7),
       WVLUInt<3>(0x92384923EDE34831, 0xFFDC33442341223D, 0x344FDCAA231DEA42),
       WVLUInt<3>(0x855815C047FD3B6F, 0x4DC68681CF9EAC96, 0x0E7B6904EAABD96E) },
     { WVLUInt<3>(0x9999999999999999, 0x9999999977777777, 0x7777777777777777),
       WVLUInt<3>(0x5555555555555555, 0x5555555555558333, 0x3333333333333333),
       WVLUInt<3>(0xCCCCC6AF37C048D1, 0x59E26AF382D8181B, 0x4E81B4E81B4E81B5) },
     { WVLUInt<3>(0x1002003004005006, 0x00700800900A00B0, 0x0C00D00E00F00111),
       WVLUInt<3>(0xFAF411223344FF99, 0x887766CCDDEEEE12, 0x3234345456567678),
       WVLUInt<3>(0xDC96140FEFC578AC, 0x8E32ACB47667D529, 0x31B8B98F22B455F8) },
    };
    ...
    const WVLUInt<4> values4[][3] =
    {{WVLUInt<4>(0xABCDEF0123456789, 0x1234567890ABCDEF, 0xAABBCCDDEEFF0011),
      WVLUInt<4>(0x1B3D605E6CBA3E5E, 0x8ABFC0F2BF8AF59E, 0x2E0191B18E8BA3AB, 0x9856577ABDDE0121),
      WVLUInt<4>(0x9AA580298FD8E299, 0xA61B6ABF0B698C4D, 0x0E9068C41A05CEB6, 0xEC2B99D3699D1331)},
     {WVLUInt<4>(0x1B3D605E6CBA3E5E, 0x8ABFC0F2BF8AF59E, 0x2E0191B18E8BA3AB, 0x9856577ABDDE0121),
      WVLUInt<4>(0x9AA580298FD8E299, 0xA61B6ABF0B698C4D, 0x0E9068C41A05CEB6, 0xEC2B99D3699D1331),
      WVLUInt<4>(0xDA324AB303CDAF44, 0x2437C777DC1AD668, 0xAD17E2B86A13456A, 0x585E01660BD0AA51)},
     {WVLUInt<4>(0x1002003004005006, 0x00700800900A00B0, 0x0C00D00E00F00111),
      WVLUInt<4>(0xFAF411223344FF99, 0x887766CCDDEEEE12, 0x3234345456567678),
      WVLUInt<4>(0xC95DCA352E40EBB3, 0xDC96140FEFC578AC, 0x8E32ACB47667D529, 0x31B8B98F22B455F8)}
    };

    if(!checkMultiplication(values4[0][0], values4[0][0], values4[0][1])) DRET;
    if(!testMultiplication(values4)) DRET;

    const WVLUInt<8> values8[][3] =
    {{WVLUInt<8>(0x1B3D605E6CBA3E5E, 0x8ABFC0F2BF8AF59E, 0x2E0191B18E8BA3AB, 0x9856577ABDDE0121),
      WVLUInt<8>(0x9AA580298FD8E299, 0xA61B6ABF0B698C4D, 0x0E9068C41A05CEB6, 0xEC2B99D3699D1331),
      WVLUInt<8>(0x1074882B06961FC6, 0x32407BE674E25854, 0xB14779D0A9EFD93F, 0xEE369F6C299D7D60,
                 0xDA324AB303CDAF44, 0x2437C777DC1AD668, 0xAD17E2B86A13456A, 0x585E01660BD0AA51)},
     {WVLUInt<8>(0xC95DCA352E40EBB3, 0xDC96140FEFC578AC, 0x8E32ACB47667D529, 0x9AA580298FD8E299,
                 0xA61B6ABF0B698C4D, 0x0E9068C41A05CEB6, 0xD7975D393A1FEF33, 0xD78B72B8101364BD),
      WVLUInt<8>(0xDA324AB303CDAF44, 0x2437C777DC1AD668, 0xAD17E2B86A13456A, 0x585E01660BD0AA51,
                 0xCCCCC6AF37C048D1, 0x59E26AF382D8181B, 0x4E81B4E81B4E81B5, 0x8E32ACB47667D529),
      WVLUInt<8>(0x011DE507E6984287, 0x59AC020BAF1ECF50, 0x8487454A68B7222F, 0xEE97DA0F32576C88,
    ...
    WVLUInt<10> vG(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
                   0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF);
    WVLUInt<10> vH(0, 0, 0, 0,
    ...
    WVLUInt<3> vI(0x8ABFC0F2BF8AF59E, 0x2E0191B18E8BA3AB, 0x9856577ABDDE0121);
    factor = UINT64_C(0xAABBCCDDEEFF0011);
    WVLUInt<3> vJ(0xA26487FEBC5FB714, 0x16F821BCBFD053E7, 0xEC2B99D3699D1331);
...
{
    WVLUInt<kSize> positive, negative, result;
...
(const char* title, const WVLUInt<kSize>& resultValue, double seconds)
{
...
static void runAdditionBenchmarks()
{
    ...
    WVLUInt<kSize> value1, value2(-1000000000001);
    for(std::size_t i = 0; i < kSize; ++i)
        value1.data()[i] = -10;
    ...
    for(unsigned i = 0; i < 10000000; ++i)
        value1 += value2;
    printBenchmarkResult("operator+=(WVLUInt)", value1, timer.getTimeIntervalNow());
...
static void runMultiplicationBenchmarks()
{
    ...
    WVLUInt<kSize> value1(3), value2(5);
    Timer timer;

    for(unsigned i = 0; i < 40000; ++i)
        value2 *= value1;

    printBenchmarkResult("operator*=(WVLUInt)", value2, timer.getTimeIntervalNow());
}
...
static void runCombinedBenchmark()
{
    ...
    WVLUInt<kSize> value1(1), value2(3), value3(3);
    Timer timer;
